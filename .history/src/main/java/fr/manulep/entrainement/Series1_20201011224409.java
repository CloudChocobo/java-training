...
public class Series1 {
	...
	public static String[] selectElementsStartingWithVowel(String[]array) {
		//7
	ArrayList<String> wordsBeginningWithVowel = new ArrayList<String>();

	for (int i = 0; i < array.length; i++) {
		if ((array[i].substring(0, 1).equals("a"))) {
			wordsBeginningWithVowel.add(array[i]);
			}
		}
		
		String[] result = wordsBeginningWithVowel.toArray(new String[0]);
		return result;
	}
