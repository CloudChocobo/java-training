...
public class Series1 {
	...
	public static String[] selectElementsStartingWithVowel(String[] array) {
		//7
	ArrayList<String> elementStartingWithVowel = new ArrayList<String>();

	for (int i = 0; i < array.length; i++) {
		if ((array[i].substring(0, 1).equals("a")) || (array[i].substring(0, 1).equals("e")) || (array[i].substring(0, 1).equals("i")) || (array[i].substring(0, 1).equals("o")) || (array[i].substring(0, 1).equals("u")) || (array[i].substring(0, 1).equals("y")) && (array[i] != null)) {
